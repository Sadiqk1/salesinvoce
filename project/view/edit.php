...
<div class="container-fluid">
    ...
    <form action="../Controller/functions.php?method=edit" method="post">
        <div class="form-group">
            <label for="exampleFormControlInput1">Invoice Id</label>
            <input type="number" name="id" class="form-control" value="<?php echo $getid; ?>" id="exampleFormControlInput1" readonly>
        </div>
        <div class="form-group">
